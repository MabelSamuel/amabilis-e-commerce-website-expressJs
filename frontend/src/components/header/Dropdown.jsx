...
function Dropdown() {
  ...
  return (
    <div className=" leading-4 text-sm px-20 text-gray-500 border-b md:px-8 sm:h-fit sm:py-3 sm:px-4">
      <div className="flex justify-between h-14 sm:flex-col sm:items-center mx-auto my-auto container">
        <div className="flex items-center h-full">
          {languageAndCurrency.map((el, index) => (
            <div key={v4()} className=" relative border-r-2 mr-4 sm:mr-2 ">
              ...
              {isOpen === index && (
                <div className="absolute bg-white shadow-md left-0 top-full pt-2 px-3 pb-3 text-left w-32 z-[52000] transition-all duration-300 ease-in flex items-center">
                  <ul>
                    {el.items.map((item) => (
